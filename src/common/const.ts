...
export const VariableSegmentPattern = /(([a-zA-Z][a-zA-Z0-9_]*)|({[a-zA-Z][a-zA-Z0-9_]*}))/;
export const VariablePathPattern = /^(([a-zA-Z][a-zA-Z0-9_]*)|({(?:[a-zA-Z][a-zA-Z0-9_]*.?)+}))((\.[a-zA-Z][a-zA-Z0-9_]*)|(\.{(?:[a-zA-Z][a-zA-Z0-9_]*.?)+}))*$/;
